...
namespace Portal2D.Classes.Menu
{
    class GameWon
    {
        ...
        public GameWon(Texture2D _background, Texture2D _mainmenuTexture, Texture2D _playagainTexture, Texture2D _exitTexture)
        {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(Game1._score, "LEVEL COMPLETED", new Vector2(1920/2, 0), Color.White, 0f, Vector2.Zero, 4f, SpriteEffects.None, 0f);
